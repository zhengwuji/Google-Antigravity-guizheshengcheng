...
export const ITEM_DESCRIPTIONS = {
    ...
    "智能升级": "当 AI 遇到死循环、反复报错或常规逻辑无法解决的复杂问题时（重试超过 3 次），AI 无法自己切换模型，但会主动建议用户切换到推理能力更强的模型。推荐模型：Claude Sonnet 4.5 (Thinking) - 适合复杂逻辑推理；GPT-o1 - 适合数学和算法问题；Gemini Pro (Deep) - 适合大规模代码分析。用户需手动在界面上选择模型切换。",
};
